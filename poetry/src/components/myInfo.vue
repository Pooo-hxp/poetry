    ...
    <div class="app header">
        <div class="container header-info">
            ...
            <div class="row header-info-div">
                <!--头像及个人昵称 -->
                <div class="col-xs-5 col-md-4  header-info-image">
                </div>
      ...
      <div class="login" v-if='table'>
            <div class="menu">
                ...
                <p class="text-right"><a @click='close'>关闭</a></p>
            </div>
            <table class="table table-hover table-inverse " v-if='login'>
              ...
              <tbody>
                ...
                <th></th>
                <th><button class="btn btn-info btn-sm" @click='login_axios'>登录</button>
                    <button class="btn btn-danger  btn-sm" @click='createLogin_axios'>注册</button></th>
                      </tbody>
            ...
            <table class="table  table-inverse " v-if='updateInfo'>
                ...
                <tr>
                    <td>个性签名</td>
                    <td><input type="text" class="form-control" v-model='UserSayHi'>
